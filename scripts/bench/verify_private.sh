...
# Pre-transpiled source lives in the TXL workspace (transform/txl/openmptodickpt).
DICKPT_SRC_DEFAULT="${PROJECT_DIR}/transform/txl/openmptodickpt/verify_private_dickpt.c"
