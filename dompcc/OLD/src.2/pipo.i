...
void wait ( int elapse, void ( * f ) ( ) )
{
 struct itimerval new = {
  { 1, 0 },
  { elapse / 1000 , 1000 * ( elapse % 1000 ) }
 } ;

 led = f ;
 setitimer ( ITIMER_REAL, & new, ((void *)0) ) ;
 pause ( ) ;
}

void impulse ( char number [ ], int on, int off, int inter )
{
 int i, val ;
...
{
 impulse ( "0160764556", 100, 200, 500 ) ;
 return 0 ;
}
