#!/bin/bash
#SBATCH --job-name=bench_heat_mpi
#SBATCH --nodes=64
#SBATCH --ntasks=64
#SBATCH --ntasks-per-node=1
#SBATCH --time=04:00:00
#SBATCH --output=bench_heat_mpi_%j.out
#SBATCH --error=bench_heat_mpi_%j.err
#SBATCH --partition=compute

# 2D heat diffusion / Jacobi Laplace solver (iterative stencil) — pure MPI.
