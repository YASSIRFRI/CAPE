...
#SBATCH --error=bench_montecarlo_mpi_%j.err
...
APP="montecarlo"
SRC_NAME="mpi_montecarlo.c"
BIN_NAME="mpi_montecarlo"
...
echo "Nodes: ${NODES_LIST[*]}  Reps: ${REPS}  samples=${N_SAMPLES}"
echo "CSV: ${CSV}"
